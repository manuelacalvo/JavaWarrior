...
module Yuki
  ...
  module Transitions
    ...
    def directed(direction = -1)
      ...
      sp1.shader = shader = Shader.new(DirectedShader)
      sp1.shader.set_float_array_uniform("yval",
        Array.new(10) do |i|
          (w + 10*i) / w2
        end
      )
    ...
    def weird_transition(nb_frame = 60, radius = 0.25, max_alpha = 0.5, min_tau = 0.07, delta_tau = 0.07, bitmap: nil)
      ...
      sp.bitmap = bitmap ? bitmap : Graphics.snap_to_bitmap
