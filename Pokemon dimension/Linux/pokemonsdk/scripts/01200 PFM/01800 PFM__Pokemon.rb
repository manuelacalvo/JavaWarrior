...
module PFM
  ...
  class Pokemon
    ...
    def code_generation(force_shiny = false, no_shiny = false)
      ...
      shiny_chance = $bag.has_item?(632) ? 0x0556 : 0x1000
    ...
    def get_data
      return $game_data_pokemon[@id][@form]
    end
    ...
    def breed_group
      return $game_data_pokemon[@id][@form].breed_groupes
    end
    # Return the breed moves of the Pokemon (list of skill ID)
    # @return [Array<Integer>]
    def breed_move
      return $game_data_pokemon[@id][@form].breed_moves
    end
    ...
    def captured_zone_name
      if d = $game_data_zone[@captured_in & 0xFFFF]
        return _utf8(d.map_name.to_s)
      end
=begin
      map_id=@captured_in&0xFFFF
...
=end
    ...
    # @return [Integer]
    def rareness
      return @rareness ? @rareness : $game_data_pokemon[@id][@form].rareness
    end
    ...
    # @return [Numeric]
    def height
      return $game_data_pokemon[@id][@form].height
    end
    # Return the weight of the Pokemon
    # @return [Numeric]
    def weight
      return $game_data_pokemon[@id][@form].weight
    end
