...
public class SkinGenerator {
    ...
    public static Skin generateSkin(AssetManager assetManager){
        ...
        if (!assetManager.isLoaded("core/assets/graphics/ui/pokemon-ui/uipack.atlas")) {
            throw new GdxRuntimeException("uipack.atlas was not loaded");
        }

        TextureAtlas uiAtlas = assetManager.get("core/assets/graphics/ui/pokemon-ui/uipack.atlas");
        ...
        FreeTypeFontGenerator generator = new FreeTypeFontGenerator(Gdx.files.internal("core/assets/font/pokemon/pkmnrsi.ttf"));
        ...
        BitmapFont smallFont = assetManager.get("core/assets/font/pokemon/small_letters_font.fnt", BitmapFont.class);
